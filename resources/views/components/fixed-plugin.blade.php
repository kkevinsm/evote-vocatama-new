<div class="fixed-plugin">
  ...
  <div class="card shadow-lg ">
    ...
    <div class="card-body pt-sm-3 pt-0">
      ...
      <div class="d-flex">
        <button class="btn bg-gradient-primary w-100 px-3 mb-2 active" data-class="bg-white" onclick="sidebarType(this)">White</button>
        <button class="btn bg-gradient-primary w-100 px-3 mb-2  {{ (Request::is('rtl') ? 'me-2' : 'ms-2') }}" data-class="bg-transparent" onclick="sidebarType(this)">Transparent</button>
      </div>
